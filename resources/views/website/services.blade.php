    ...
    <section class="projects-clean">
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/mapping.jpg">
                ...
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/boundaries.jpg">
                ...
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/subdivision.jpg">
                ...
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/parcel%20identification.jpg">
                ...
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/rectify.jpg">
                    <h3 class="name">RECTIFYING POORLY MAPPED FEATURES</h3>
                ...
                <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="assets/img/training.jpg">
